...
export class AdmobFreeProvider {
  // https://github.com/gengjunwu/admob-free-ionic2-demo
  public admobId;
  ...
  constructor(public http: Http, private platform: Platform, private admobFree: AdMobFree, private alertCtrl: AlertController) {
